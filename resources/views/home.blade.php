...
@section('header-content')
  <h1 class="text-white">AHSAN HOUSE</h1>
  <p class="lead mb-4 text-white opacity-8">One Stop Room Rent, One Payment All Facilities</p>
  <button type="submit" class="btn bg-white text-dark">Pesan Sekarang</button>
  <h6 class="text-white mb-2 mt-5">Komunikasi lebih dekat, dengan kami</h6>
  <div class="d-flex justify-content-center">
    <a href="javascript:;"><i class="fab fa-whatsapp text-lg text-white me-4"></i></a>
                ...
                <div class="col-lg-4 col-md-6 col-12 mt-n5">
                  <a href="javascript:;">
                    <div class="p-3 pe-md-0">
                      <img class="w-100 border-radius-md shadow-lg" src="img/team-5.jpg" alt="image">
                    </div>
                  </a>
                </div>
            ...
            <div class="card card-profile mt-lg-4 mt-5">
              <div class="row">
                <div class="col-lg-4 col-md-6 col-12 mt-n5">
                  <a href="javascript:;">
                    <div class="p-3 pe-md-0">
                      <img class="w-100 border-radius-md shadow-lg" src="img/bruce-mars.jpg" alt="image">
                    </div>
                  </a>
                </div>
                <div class="col-lg-8 col-md-6 col-12 my-auto">
            ...
            <div class="card card-profile mt-4 z-index-2">
              <div class="row">
                <div class="col-lg-4 col-md-6 col-12 mt-n5">
                  <a href="javascript:;">
                    <div class="p-3 pe-md-0">
                      <img class="w-100 border-radius-md shadow-lg" src="img/ivana-squares.jpg" alt="image">
                    </div>
                  </a>
                </div>
                <div class="col-lg-8 col-md-6 col-12 my-auto">
            ...
            <div class="card card-profile mt-lg-4 mt-5 z-index-2">
              <div class="row">
                <div class="col-lg-4 col-md-6 col-12 mt-n5">
                  <a href="javascript:;">
                    <div class="p-3 pe-md-0">
                      <img class="w-100 border-radius-md shadow-lg" src="img/ivana-square.jpg" alt="image">
                    </div>
                  </a>
                </div>
                <div class="col-lg-8 col-md-6 col-12 my-auto">
      ...
      <div class="container">
        ...
        <div class="row justify-content-center text-center">
          <div class="col-md-3">
            ...
            <h5>hari</h5>
            <p>Jumlah hari kami melayani dan menyiapkan kamar terbaik untuk pelanggan</p>
          </div>
          <div class="col-md-3">
          ...
          <div class="col-md-3">
            <h1 class="text-gradient text-info"><span id="state3" countTo="6">0</span>/10</h1>
            <h5>Kamar</h5>
        ...
        <div class="row">
          ...
          <div class="col-md-5 ms-auto">
            <div class="position-relative">
              <img class="max-width-50 w-100 position-relative z-index-2" src="img/macbook.png" alt="image">
            </div>
          </div>
        </div>
      </div>
